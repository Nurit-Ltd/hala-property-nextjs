      ...
      <div className="container_fluid">
        <div className="py-25">
          <div className="max-w-[1038px] mx-auto">
            <div className="space-y-5 max-w-[690px] mx-auto">
              ...
              <div className="space-y-4">
                ...
                <h4 className="text-lg text-darkBlue text-center">We streamline the entire process for you. Here’s how it works:</h4>
              </div>
            </div>
            <ProcessCard />
