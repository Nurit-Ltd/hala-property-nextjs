...
const ThreeStepDreamCard = ({ step }) => {
  return (
    <div>
      <div className="px-[14px] pt-[23px] pb-[14px] lg:px-5 lg:pt-8 lg:pb-5 border border-[#EEEFF1] bg-white hover:bg-[#e0e5f1] three-steps-card rounded-2xl space-y-6 lg:space-y-8 hover:scale-[1.03]  focus:scale-[1.03] transition-all duration-300">
        <div className="space-y-4 lg:space-y-6">
          ...
          <div className="space-y-[5px] lg:space-y-2">
            ...
            <h5 className="h-9 lg:h-12 text-xs lg:text-base font-medium text-[#525D74]">
              {step.description}
            </h5>
          </div>
        </div>
