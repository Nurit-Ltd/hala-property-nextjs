...
const ElevatePropertyCard = ({ card }) => {
  return (
    <div>
      <div className=" propertyCard xl:h-[350px] rounded-2xl relative">
        <Image src={card.imageUrl} alt={card.title} fill className="object-cover  h-full w-auto rounded-2xl " />
        <div
