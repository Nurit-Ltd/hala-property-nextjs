      ...
      <div className="mt-6 mb-8 flex items-center justify-between gap-2 w-full overflow-y-scroll custom-scrollbar-tab">
        <div className="hidden lg:block">
          <Button
            ...
            variant="outline"
            className="rounded-full bg-[#F6F5F1] border-grey400 py-2.5 px-4 gap-2 hover:bg-primary/5 hover:text-primary   hover:border-primary"
          >
        ...
        <div className="flex items-center gap-4">
          {tabs.map((tab) => (
            <Button
              ...
              variant="outline"
              className={cn(
                "rounded-full bg-[#F6F5F1] text-[#323B49] border-grey400 py-2.5 px-4 gap-2 hover:bg-primary/5 hover:text-primary   hover:border-primary",
                activeTab === tab.id &&
