    ...
    <div className="mt-12">
      ...
      <div className="mt-6 p-6 border border-grey400 rounded-lg">
        <div className="grid grid-cols-5 gap-8">
          ...
          <div className="col-span-2 h-fit p-6 rounded-lg bg-primary/[5%] border border-primary/[75%] mortgage-payment-box">
            <h4 className="text-lg font-semibold text-grey700">
