        ...
        <table className="min-w-full border-collapse">
          <thead>
            <tr className="bg-grey100">
              <th className="px-4 py-3 text-sm text-center text-grey600 font-semibold rounded-tl-md rounded-bl-md">
                No
              </th>
              <th className="px-4 py-3 text-sm text-center text-grey600 font-semibold">
                Location
              </th>
              <th className="px-4 py-3 text-sm text-center text-grey600 font-semibold">
                Avg. price/sqf
              </th>
              <th className="px-4 py-3 text-sm text-center text-grey600 rounded-tr-md rounded-br-md font-semibold">
                VS Q3 2024
              </th>
            </tr>
          </thead>
          <tbody className="pt-3 gap-2">
            {locationsData.map((location, index) => (
              <tr key={location.id} className="border-b border-grey300">
                <td className="px-4 py-2.5 text-center font-medium text-grey700">
                  {index + 1}
                </td>
                <td className="px-4 py-2.5 text-center font-medium text-grey700">
                  {location.name}
                ...
                <td className="px-4 py-2.5 text-center font-medium text-grey700 flex items-center gap-[6px]">
                  <Image
