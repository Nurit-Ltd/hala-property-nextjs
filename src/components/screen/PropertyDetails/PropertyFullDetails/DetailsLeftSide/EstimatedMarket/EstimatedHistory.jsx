    ...
    <div className="mt-4 p-2.5 md:p-6 bg-white border border-grey400 rounded-lg">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-1.5 md:gap-0">
        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          <button className="h-[25px] md:h-[32px] px-2 md:px-3 py-1 md:py-1.5 rounded-[2.5px] md:rounded-md flex items-center justify-center border border-grey400 text-xs md:text-sm font-semibold text-grey600">
            3 years
          </button>
          <button className="h-[25px] md:h-[32px] px-2 md:px-3 py-1 md:py-1.5 rounded-[2.5px] md:rounded-md flex items-center justify-center border border-primary text-xs md:text-sm font-semibold text-primary">
            5 years
          </button>
          <div className="h-[25px] md:h-[32px] px-2 md:px-3 py-1 md:py-1.5 rounded-[2.5px] md:rounded-md flex items-center justify-center border border-grey400 bg-primary/[5%] text-primary gap-1.5 md:gap-2">
            ...
            <h4 className="text-xs md:text-sm font-semibold text-grey600">
              Unlock more data
            </h4>
            <Link
              href={"#"}
              className="text-xs md:text-sm font-semibold text-primary underline"
            >
              Sign in
            </Link>
          </div>
