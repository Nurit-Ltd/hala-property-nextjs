        ...
        <div className="col-span-5 relative">
          ...
          <div className="absolute left-4 bottom-4 flex items-center gap-2 z-20">
            {absoluteData.map((button, btnIndex) => (
              <button
                key={btnIndex}
                className="h-[38px] px-3 py-2 rounded-md bg-black/[25%] hover:bg-[rgba(9,84,229,0.5)] focus:bg-bg-[rgba(9,84,229,0.5)] border border-white/[60%] focus:border-white/[60%] hover:border-white/[90%] flex items-center transition-all justify-center gap-1 font-semibold text-white   app-button-box-pro"
              >
                <Image
                  src={button.icon}
                  alt={button.label}
