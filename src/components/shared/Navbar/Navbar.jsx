          ...
          <div className="w-full h-12 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2 xl:gap-4">
                <button onClick={handleAiClick} className=" cursor-pointer px-2 xl:px-5 py-2 h-12 rounded-lg border border-white/[30%] nav-ai-button-box flex items-center justify-center gap-1 xl:gap-2 text-xs xl:text-base text-white font-medium">
                  <Image src={starIcon} alt="starIcon" />
                  Find Property with AI
                </button>
                <Link href={"/auth"} className="h-12 px-3 xl:px-8 py-2 bg-gradient-to-r from-[#0E5DF4] to-[#004BDC] border border-black/[8%] text-xs xl:text-base rounded-lg flex items-center justify-center text-white font-semibold hover:from-[#0E5DF4CC] hover:to-[#004BDCCC]">
                  Sign in
                </Link>
              </div>
            </div>
