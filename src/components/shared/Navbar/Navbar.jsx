          ...
          <div className="w-full h-12 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2 xl:gap-4">
                ...
                <Link
                  href={"/auth"}
                  className="h-12 px-3 xl:px-8 py-2 bg-gradient-to-r from-[#0E5DF4] to-[#004BDC] border border-black/[8%] text-xs xl:text-base rounded-lg flex items-center justify-center text-white font-semibold hover:from-[#0E5DF4CC] hover:to-[#004BDCCC] transition-all duration-300 ease-in-out"
                >
                  Sign in
                </Link>
              </div>
