...
const MapViewPage = () => {
  ...
  return (
    <div className="mt-15 lg:mt-24  overflow-hidden w-full relative">
        ...
        <div className="mapouter">
          <div className="gmap_canvas">
            <Image
              ...
              width={1728}
              height={1433}
              className="gmap_iframe h-full w-full"
              src="/map.png"
            />
          </div>
        </div>
      ...
      {/* cards  */}
      <div className="absolute top-28 desk:top-6  bg-white border border-grey400 drop-shadow  max-w-[750px] w-full left-24 desk:left-auto  desk:right-16 bottom-8 hidden lg:block overflow-y-scroll custom-scrollbar-tab rounded-[16px]">
        <div className="p-4 ">
