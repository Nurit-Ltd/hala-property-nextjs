      ...
      <div className="relative h-[530px] xl:h-[650px]  bg-[#f7f5f2] xl:bg-white ">
        ...
        <div className="  pt-10 xl:pt-[100px] flex flex-col items-center max-w-[1015px] mx-auto px-4 xl:px-0  gap-2  ">
          ...
          <p className="text-base xl:text-lg   text-center  text-gray-700">
            Whether you need help finding your perfect home or looking for the
            ideal investment property, contact us today. Our expert team of
            property consultants is dedicated to providing you with exceptional
            service and helping you find your dream home.
          </p>
        </div>
            ...
            >
              <div className="   flex flex-col lg:flex-row justify-between gap-4 xl:gap-6">
                ...
                <div className="w-full">
                  <label className="block text-[#0D152E] text-base font-semibold  mb-2">
                    Your Name
                  </label>
                  <input
                    type="text"
              ...
              <div className="mt-4 xl:mt-6">
                ...
                <textarea
                  ...
                  className=" h-[148px] lg:h-[220px] appearance-none border rounded-lg w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              ...
              <button
                type="submit"
                className=" mt-[36px] h-14 w-full py-3 px-4 bg-primary submitBtnShadow     hover:bg-blue-700 text-white font-bold rounded-lg focus:outline-none tracking-[2%] focus:shadow-outline"
              >
                Send
              </button>
            </form>
        ...
        <div className=" p-[20px] xl:p-[30px] w-full max-w-[1280px] mx-auto   ">
          <div className="flex flex-col xl:flex-row   gap-8 items-center justify-center w-full">
            <div className="w-full max-w-[405px] h-[308px] rounded-2xl p-6 text-white border border-[#FFFFFF33]">
              ...
              <h3 className="text-2xl mt-8 font-bold text-white">
                Help & support
              </h3>
              <p className=" text-base xl:text-lg mt-4">
                Email:{" "}
                <a
                  className="text-[#3371E9] text-lg"
                  href="mailto:info@halaproperty.com"
                >
            ...
            <div className="w-full max-w-[405px] h-[308px] rounded-2xl p-6 text-white border border-[#FFFFFF33]">
              ...
              <p className="text-base xl:text-lg mt-4">
                <a
                  className="text-[#3371E9] text-base xl:text-lg"
                  href="tel: + 971 362 2254"
                >
                  + 971 362 2254
                </a>
              </p>
          ...
          <div className="flex flex-col xl:flex-row  xl:justify-between items-center gap-[40px] xl:items-stretch  ">
            ...
            <div className="w-full max-w-[640px]  flex flex-col justify-center   ">
              <p className=" mt-[6px] xl:mt-3 text-sm xl:text-lg      text-gray-700">
                ...
                with the best service possible. You can reach us through email
                at{" "}
                <a
                  className="text-[#0954E5]"
                  href="mailto:info@halaproperty.com"
                >
                  info@halaproperty.com
                </a>
                , or by filling out the contact form on our website. We look
              ...
              <div className="flex gap-4 mt-6 xl:mt-[60px]">
                {socialLinks.map((link, index) => (
                  <a
                    ...
                    key={index}
                    href={link.link}
                    className="w-[32px] h-[32px] rounded-full bg-darkBlue flex items-center justify-center text-white"
                  >
