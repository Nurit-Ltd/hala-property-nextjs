    ...
    <div className="pt-[60px] lg:pt-24 font-Manrope bg-white">
      ...
      <div className="relative h-[530px] xl:h-[650px]  bg-[#f7f5f2] xl:bg-white ">
        ...
        <div className="  pt-10 xl:pt-[100px] flex flex-col items-center max-w-[1015px] mx-auto px-4 xl:px-0  gap-2  ">
          <h2 className="text-xl lg:text-3xl  xl:text-[48px] font-bold  text-gray-900 leading-tight">
            Let's <span className="text-primary">Talk</span>
          </h2>
          <p className="text-base xl:text-lg   text-center  text-gray-700">Whether you need help finding your perfect home or looking for the ideal investment property, contact us today. Our expert team of property consultants is dedicated to providing you with exceptional service and helping you find your dream home.</p>
        </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="  ">
              <div className="   flex flex-col lg:flex-row justify-between gap-4 xl:gap-6">
                ...
                <div className="w-full">
                  ...
                  <input type="text" {...register("name", { required: "Name is required" })} className="appearance-none border rounded-lg w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter your first & last name" />
              ...
              <div className="mt-4 xl:mt-6 flex flex-col lg:flex-row justify-between gap-4 xl:gap-6">
                ...
                <div className="w-full">
                  ...
                  <input type="tel" {...register("phone", { required: "Phone is required" })} className="appearance-none border rounded-lg w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter your pohone number" />
                ...
                <div className="w-full">
                  ...
                  <input type="text" {...register("subject", { required: "Subject is required" })} className="appearance-none border rounded-lg w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter a subject line" />
              ...
              <div className="mt-4 xl:mt-6">
                ...
                <textarea {...register("message", { required: "Message is required" })} className=" h-[148px] lg:h-[220px] appearance-none border rounded-lg w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Write your message" rows={4}></textarea>
        ...
        <div className="w-full max-w-[1280px] mx-auto ">
          <div className="flex flex-col xl:flex-row  xl:justify-between items-center gap-[40px] xl:items-stretch  ">
            ...
            <div className="w-full max-w-[640px]  flex flex-col justify-center   ">
              <p className=" mt-[6px] xl:mt-3 text-sm xl:text-lg      text-gray-700">
              ...
              <div className="flex gap-4 mt-6 xl:mt-[60px]">
                {socialLinks.map((link, index) => (
                  <a alt={link.title} key={index} href={link.link} className="w-[32px] h-[32px] rounded-full bg-darkBlue flex items-center justify-center text-white">
